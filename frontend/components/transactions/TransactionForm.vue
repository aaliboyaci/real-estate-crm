<template>
  <form @submit.prevent="handleSubmit" class="space-y-4">
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <div>
        <label class="block text-sm font-medium text-slate-700 mb-1">Property Price (EUR)</label>
        <input
    ...
    <div>
      <label class="block text-sm font-medium text-slate-700 mb-1">Service Fee (EUR)</label>
      <input
    ...
    <div class="grid grid-cols-2 gap-4">
      <div>
        <label class="block text-sm font-medium text-slate-700 mb-1">Listing Agent</label>
        <AgentsAgentSelect v-model="form.listingAgent" />
      </div>
      <div>
        <label class="block text-sm font-medium text-slate-700 mb-1">Selling Agent</label>
    ...
    <div class="flex justify-end gap-3 pt-2">
      ...
      <button
        type="submit"
        :disabled="submitting"
        class="px-4 py-2 text-sm font-medium bg-slate-900 text-white rounded-lg hover:bg-slate-800 disabled:opacity-50 transition-colors"
      >
